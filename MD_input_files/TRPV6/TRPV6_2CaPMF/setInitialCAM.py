...
# start site near protein
wat = u.select_atoms("name "+water_O_name+" and prop z < "+str(criPos+24)+" and prop z > "+str(criPos+22)+" and prop x<"+str(target_x+3)+" and prop x>"+str(target_x-3)+
